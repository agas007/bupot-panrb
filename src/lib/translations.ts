export const translations = {
  ID: {
    ...
    team: {
      title: "Manajemen Tim",
      subtitle: "Tambah user dan kelola hak aksesnya.",
      add_member: "Tambah User Baru",
      ...
      role_archivist: "Petugas Arsip (Kelola Arsip)",
      invite: "Tambah User",
      active_members: "User Aktif",
      list_title: "Daftar User",
      filter_role: "Filter Role",
      all_roles: "Semua Role",
      filtered_count: "user ditampilkan",
      no_filtered_results: "Tidak ada user dengan role yang dipilih.",
      table_name: "Nama",
      ...
      table_actions: "Aksi",
      loading: "Memuat tim...",
      not_found: "Belum ada user yang ditambahkan.",
      tasks: "tugas",
  ...
  EN: {
    ...
    team: {
      ...
      subtitle: "Add users and manage their access roles.",
      add_member: "Add New User",
      full_name: "Full Name",
      ...
      role_archivist: "Archivist (Archive Management)",
      invite: "Add User",
      active_members: "Active Users",
      list_title: "User List",
      filter_role: "Filter Role",
      all_roles: "All Roles",
      filtered_count: "users shown",
      no_filtered_results: "No users match the selected roles.",
      table_name: "Name",
      table_username: "Username",
      table_roles: "Roles",
      table_tasks: "Tasks",
